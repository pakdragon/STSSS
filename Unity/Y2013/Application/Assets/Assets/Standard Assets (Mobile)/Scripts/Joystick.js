...
function Start()
{
	...
	gui.pixelInset = Rect(gui.pixelInset.x,gui.pixelInset.y,(Screen.width*10)/100,(Screen.width*10)/100);
	
	// Store the default rect for the gui, so we can snap back to it
	defaultRect = gui.pixelInset;	
    
    defaultRect.x += (transform.position.x * Screen.width)-(Screen.width*10)/200f;// + gui.pixelInset.x; // -  Screen.width * 0.5;
    defaultRect.y += (transform.position.y * Screen.height)-(Screen.height*25)/200f;// - Screen.height * 0.5;
