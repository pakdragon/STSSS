...
public class Menu : MonoBehaviour {
	...
	void Resize() {
		...
		tutorial.pixelInset = new Rect((20f/32f)*Screen.width,(15f/32f)*Screen.height,(1.5f/8f)*Screen.width,(3f/6f)*Screen.height);
		photos.pixelInset = new Rect((5f/32f)*Screen.width,(10f/32f)*Screen.height,(1.5f/8f)*Screen.width,(3f/6f)*Screen.height);
		videos.pixelInset = new Rect((20f/32f)*Screen.width,(10f/32f)*Screen.height,(1.5f/8f)*Screen.width,(3f/6f)*Screen.height);
		...
		about.pixelInset = new Rect((20f/32f)*Screen.width,(.5f/32f)*Screen.height,(1.5f/8f)*Screen.width,(3f/6f)*Screen.height);
