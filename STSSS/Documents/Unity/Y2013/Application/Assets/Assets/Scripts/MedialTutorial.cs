...
public Vector3[] rotations = new Vector3[4];
	...
	*/
	...
	void screenResize() {
		...
		Step1.guiTexture.pixelInset = new Rect((250f/512f)*Screen.width, (40f/512f)*Screen.width, 15*(1f/12f)*Screen.height,(9f/12f)*Screen.height-2f*(5f/512f)*Screen.width);
		Step2.guiTexture.pixelInset = new Rect((250f/512f)*Screen.width, (40f/512f)*Screen.width, 15*(1f/12f)*Screen.height,(9f/12f)*Screen.height-2f*(5f/512f)*Screen.width);
		Step3.guiTexture.pixelInset =new Rect((250f/512f)*Screen.width, (40f/512f)*Screen.width, 15*(1f/12f)*Screen.height,(9f/12f)*Screen.height-2f*(5f/512f)*Screen.width);
		Step4.guiTexture.pixelInset = new Rect((250f/512f)*Screen.width, (40f/512f)*Screen.width, 15*(1f/12f)*Screen.height,(9f/12f)*Screen.height-2f*(5f/512f)*Screen.width);
